...
public class ValidateOrderAction implements Action<BeerOrderStatusEnum, BeerOrderEventEnum> {
    ...
    public void execute(StateContext<BeerOrderStatusEnum, BeerOrderEventEnum> stateContext) {
        ...
        beerOrderOptional.ifPresentOrElse(beerOrder -> jmsTemplate.convertAndSend(JmsConfig.VALIDATE_ORDER_QUEUE,
        ...
        log.debug(String.format("Sent validation request to queue order for orderId = %s", beerOrderId));
    }
}
